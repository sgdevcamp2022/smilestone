...
const WebCamStreamer = () => {
  ...
  const [socket, setSocket] = useState<Socket>(
    io("43.200.154.60:3000/mediasoup")
  );
        ...
        socket.emit(
          ...
          async (data: any) => {
            ...
            if (device.canProduce("video")) {
                ...
                async ({ params }: any) => {
                  ...
                  producerTransport.on(
                    ...
                    async ({ dtlsParameters }, callback, errback) => {
                      try {
                        socket.emit("send-transport-connect", streamer, {
                          dtlsParameters,
                        });
                        callback();
                      } catch (error) {
              ...
              console.log(
                "FUFUFFFFFFFFFFFFFFFFFFFFFFFUUUUUUUUUUUUUUUUUUUUUUUUUUUUUUUUUUUUUUUUUCCCCCCCCCCCCCCCKKKKKKKKKK"
              );
            }
          }
        );
