...
const stompClient = Stomp.over(new SockJS("http://3.34.86.115:8090/smilestone/chat"))
...
export default function TestChat() {
  ...
  const onClickSendMessage2 = () => {
    stompClient.send(`/pub/chat.${roomId2}`, {}, JSON.stringify({roomId: roomId2, sender: username, message: message2, chatAt: new Date().toISOString()}))
  }
